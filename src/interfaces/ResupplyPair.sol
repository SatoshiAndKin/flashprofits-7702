...
library RewardDistributorMultiEpoch {
    struct EarnedData {
        address token;
        uint256 amount;
    }
...
interface ResupplyPair {
    ...
    function addInterest(bool _returnAccounting)
        ...
        returns (
            ...
            ResupplyPairCore.CurrentRateInfo memory _currentRateInfo,
    ...
    function previewAddInterest()
        ...
        returns (
            uint256 _interestEarned,
            ResupplyPairCore.CurrentRateInfo memory _newCurrentRateInfo,
            uint256 _claimableFees,
            VaultAccount memory _totalBorrow
        );
